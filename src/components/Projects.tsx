  ...
  <Card className="overflow-hidden rounded-lg bg-white shadow-md dark:bg-gray-950">
    <CardContent>
      <div className="p-6 flex flex-col items-center">
        ...
        />
        <h3 className="mb-2 pt-4 text-xl font-bold text-center">{project.title}</h3>
        <p className="mb-4 text-gray-600 dark:text-gray-400 text-center">{project.description}</p>
